		...
		case 'message_new':
			...
			switch ($message) {
				...
				case 'дуцсколькоосталось':
					$otvet = time_elapsed_string('2019-10-10 00:00:00', true);
					break;
				...
				case '':
					if ($attachments_type == "audio_message") {
						$voice_link_mp = $data->object->attachments[0]->audio_message->link_ogg;
						...
						$ch = curl_init();
						$header = array("Authorization: Bearer QCDW4ADLLIDB3NYO2OTDAPZAOQQXC2BU","Content-Type: audio/ogg","Transfer-Encoding: chunked",'@'."{$voice_link_ogg}");
